...
cd $KIN_GEN_ROOT
./ilk-generator.sh --robot $KIN_GEN_ROOT/tests/models/ur5/ur5-kul.kindsl --query $SAMPLE_QUERIES/sample_all/model/ur5.dtdsl --output-dir $FUNCTIONAL_ROOT/generated
